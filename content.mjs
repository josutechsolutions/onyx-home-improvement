...
/* --- Blog ---------------------------------------------------------------
   Client-supplied article HTML is stored unchanged in blog-content/*.source.
   The records below connect each source document to its date, author, and
   local featured image; build.mjs derives its title, description, slug, body,
   table of contents, and FAQ directly from that supplied document.
   ...
   To publish the blog later, set `noindex` to false and run `node build.mjs`.
   No generated HTML needs to be edited manually.
   ------------------------------------------------------------------------ */
...
export const BLOG_POSTS = [
  {
    source: 'blog-content/how-to-choose-the-best-retaining-wall-for-your-property.source',
    date: '2026-09-10',
    author: 'Onyx Home Improvement LLC',
    image: {
      src: '/assets/img/projects/block-retaining-wall-steps-vienna-va-1200.jpg',
      width: 1200,
      height: 849,
    },
  },
  {
    source: 'blog-content/concrete-vs-asphalt-driveway.source',
    date: '2026-09-10',
    author: 'Onyx Home Improvement LLC',
    image: {
      src: '/assets/img/blog/concrete-vs-asphalt-driveway.png',
      width: 1536,
      height: 1024,
    },
  },
  {
    source: 'blog-content/what-is-the-difference-between-foundation-underpinning-vs-foundation-repair.source',
    date: '2026-09-10',
    author: 'Onyx Home Improvement LLC',
    image: {
      src: '/assets/img/blog/foundation-underpinning-vs-foundation-repair.png',
      width: 1536,
      height: 1024,
    },
  },
